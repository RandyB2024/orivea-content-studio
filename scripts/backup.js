...
async function run() {
  ...
  const tables = ["campaigns", "campaign_bundles", "bundle_items", "content_items", "content_knowledge_links", "knowledge_documents", "knowledge_chunks", "media_assets", "media_tags", "studio_posts", "post_media", "post_knowledge_sources", "post_platforms", "post_versions", "social_accounts", "publication_logs", "ai_generations", "agent_tasks", "agent_events", "agent_state", "scent_club_requests", "scent_club_members", "scent_club_selections", "scent_club_events", "settings"];
